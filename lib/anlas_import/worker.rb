...
module AnlasImport
  ...
  class Worker
      ...
      @saver = lambda { |artikul, artikulprod, name, price, purchasing_price, price_old, in_order|
        ...
        unless skip_by_name(name)
          ...
          if target_exists(artikul)
            ...
            if update(name, price, purchasing_price, price_old, in_order, artikulprod, artikul)
              @upd << artikul
            end
    ...
    def update(name, price, purchasing_price, price_old, in_order, artikulprod, artikul)
